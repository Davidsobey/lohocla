...
if(IsInjected($socialmedia)) {
  $errorMSG .= "Bad subject value!";
}
if(IsInjected($email)) {
    $errorMSG .= "Bad email value!";
}
if(IsInjected($cellno)) {
    $errorMSG .= "Bad subject value!";
}
if(IsInjected($surname)) {
...
$EmailTo = "presales@Lohoclaglobal.com, info@Lohoclaglobal.com";
$Subject = "Lohocla: New Request"; 
// prepare email body text presales@Lohoclaglobal.com, info@Lohoclaglobal.com
